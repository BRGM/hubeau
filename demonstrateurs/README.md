...
## Piézométrie (niveau des nappes d'eau souterraine)  
...
[Observations élaborées (débits moyens journaliers ou mensuels](https://hubeau.eaufrance.fr/sites/default/files/api/demo/hydro_elab.htm)  
[Observations temps réel (hauteurs et débits)](https://hubeau.eaufrance.fr/sites/default/files/api/demo/hydro_tr.htm)  

## Qualité de la ressource en eau  
[Qualité physico-chimique des nappes d'eau souterraine](https://hubeau.eaufrance.fr/sites/default/files/api/demo/qualnap.htm)  
